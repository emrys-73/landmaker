    ...
    // @ts-nocheck
        ...
        let svgs = {
            ...
            tiktok: `<svg viewBox="0 0 79 90" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6  opacity-40 hover:opacity-100">
                ...
                `,
            linkdIn: `<svg xmlns="http://www.w3.org/2000/svg" fill="none"  viewBox="0 0 24 24" class="w-6 h-6  opacity-40 hover:opacity-100"><path d="M19,3H5C3.895,3,3,3.895,3,5v14c0,1.105,0.895,2,2,2h14c1.105,0,2-0.895,2-2V5C21,3.895,20.105,3,19,3z M9,17H6.477v-7H9 V17z M7.694,8.717c-0.771,0-1.286-0.514-1.286-1.2s0.514-1.2,1.371-1.2c0.771,0,1.286,0.514,1.286,1.2S8.551,8.717,7.694,8.717z M18,17h-2.442v-3.826c0-1.058-0.651-1.302-0.895-1.302s-1.058,0.163-1.058,1.302c0,0.163,0,3.826,0,3.826h-2.523v-7h2.523v0.977 C13.93,10.407,14.581,10,15.802,10C17.023,10,18,10.977,18,13.174V17z"/></svg>`,
        ...
        let testLinks = [
                {
                    "title": "web",
                    "bg_class": "hover:bg-[#612F1D]",
                    "alt_color": "#2162FA",
                    "url": "https://abbeyugc.my.canva.site/abbeyugc"
                },
                {
                    "title": "email",
                    "bg_class": "hover:bg-[#D2EDFA]",
                    "alt_color": "#0F0F20",
                    "url": "abbeylewismarketing@gmail.com",
                },
                {
                    "title": "tiktok",
                    "alt_bg_class": "#00f2ea",
                    "bg_class": "hover:bg-[#ff0050]",
                    "url": "https://www.tiktok.com/@abbeyugc"
                },
                {
                    "title": "twitter",
                    "bg_class": "hover:bg-[#1DA1F2]",
                    "alt_color": "#C221FA",
                    "url": "https://twitter.com/abbeyyugc"
                },
                {
                    "title": "instagram",
                    "bg_class": "hover:bg-[#cd486b]",
                    "alt_color": "#7B21FA",
                    "url": "https://www.instagram.com/abbeyugc/?hl=en"
                }
            ]
                ...
                <div class="px-8 {data?.user?.fade ? 'pb-8 pt-4' : 'py-6'} h-full w-full gap-6 flex flex-col {data?.user?.darkMode ? 'bg-[#030304] text-[#F9F9F9]' : 'bg-white text-[#030304]'}">
                    <div class="w-full h-full gap-2 flex flex-col justify-start items-start">
                        ...
                        <div class="w-full h-full flex flex-row justify-start items-center gap-2">
                            {#each tags as t}
                                <div class="{data?.user?.darkMode ? 'bg-white bg-opacity-10' : 'bg-black bg-opacity-10'} px-4 py-1 text-sm rounded-2xl backdrop-blur-lg z-40">
                                    {t}
                                </div>
                            {/each}
                        </div>
                    ...
                    <div class="w-full h-full flex flex-col justify-center items-center">
                        <Button href={`https://ai.astralta.com/${data?.user?.username}`} class="{$animate} w-full rounded-full {data?.user?.darkMode ? 'bg-white text-black' : 'bg-black bg-opacity-10 '}">
                            Talk to my AI
                        </Button>
                    </div>
                </div>
